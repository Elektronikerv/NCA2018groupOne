...
BEGIN
	...
	FOR i IN 101..400 BY 1 LOOP
		...
		VALUES			(i,	1+round(random()*7), 8,  i, 500+currval('orders_id_seq'), CURRENT_TIMESTAMP, CURRENT_TIMESTAMP , 'Some description','Some feedback'),
	...
	FOR i IN 301..450 BY 1 LOOP
		INSERT INTO orders	(user_id, office_id, order_status_id, sender_address_id, receiver_address_id, creation_time , execution_time, description, feedback)
		VALUES			(i,	1+round(random()*7), 6, i, 500+currval('orders_id_seq'), CURRENT_TIMESTAMP, NULL ,'Some description', NULL);
	END LOOP;

	-- CONFIRMED ORDERS ( USERS FROM 401 - TILL 500 )
	FOR i IN 401..500 BY 1 LOOP
		INSERT INTO orders	(user_id, office_id, order_status_id, sender_address_id, receiver_address_id, creation_time , execution_time, description, feedback)
		VALUES			(i,	1+round(random()*7), 5, i, 500+currval('orders_id_seq'), CURRENT_TIMESTAMP, CURRENT_TIMESTAMP ,'Some description', NULL);
	END LOOP;

	-- PROCESSING ORDERS ( USERS FROM 451 - TILL 500 )
	FOR i IN 451..500 BY 1 LOOP
		INSERT INTO orders	(user_id, office_id, order_status_id, sender_address_id, receiver_address_id, creation_time, execution_time, description, feedback)
		VALUES			(i,	1+round(random()*7), 4, i, 500+currval('orders_id_seq'), CURRENT_TIMESTAMP, NULL ,'Some description', NULL);
	END LOOP;

	-- POSTPONED ORDERS ( USERS FROM 451 - TILL 500 )
	FOR i IN 451..500 BY 1 LOOP
		INSERT INTO orders	(user_id, office_id, order_status_id, sender_address_id, receiver_address_id, creation_time , execution_time, description, feedback)
		VALUES			(i,	1+round(random()*7), 2, i, 500+currval('orders_id_seq'), CURRENT_TIMESTAMP, NULL ,'Some description', NULL);
	END LOOP;
	...
	FOR i IN 101..200 BY 1 LOOP
		INSERT INTO orders	(user_id, office_id, order_status_id, sender_address_id, receiver_address_id, creation_time , execution_time, description, feedback)
		VALUES			(i,	1+round(random()*7), 3, i, 500+currval('orders_id_seq'), CURRENT_TIMESTAMP, NULL ,'Some description', NULL);
	END LOOP;
	...
	FOR i IN 1..900 BY 1 LOOP
		...
		VALUES	(i, round(random()*29)+20 ,round(random()*9)+10 , CURRENT_TIMESTAMP-interval '1 day', CURRENT_TIMESTAMP-interval '1 day', 1);
