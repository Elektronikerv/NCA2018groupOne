    ...
    INSERT INTO order_status (name, description)
		VALUES	('DRAFT','DRAFT'),
                ...
                ('COMPLITED','COMPLITED');
					...
					VALUES				(i,	1+round(random()*7), 8,  i, 500+currval('orders_id_seq'), CURRENT_TIMESTAMP(2), CURRENT_TIMESTAMP(2), CURRENT_TIMESTAMP(2), CURRENT_TIMESTAMP(2) ,'Some description','Some feedback'),
										(i,	1+round(random()*7), 8,  i, 500+currval('orders_id_seq'), CURRENT_TIMESTAMP(2), CURRENT_TIMESTAMP(2), CURRENT_TIMESTAMP(2), CURRENT_TIMESTAMP(2) ,NULL ,'Some feedback'),
                    					(i,	1+round(random()*7), 8,  i, 500+currval('orders_id_seq'), CURRENT_TIMESTAMP(2), CURRENT_TIMESTAMP(2), CURRENT_TIMESTAMP(2), CURRENT_TIMESTAMP(2) ,'Some description','Some feedback'),
										(i,	1+round(random()*7), 8,  i, 500+currval('orders_id_seq'), CURRENT_TIMESTAMP(2), CURRENT_TIMESTAMP(2), CURRENT_TIMESTAMP(2), CURRENT_TIMESTAMP(2) ,NULL ,'Some feedback'),
										(i,	1+round(random()*7), 7,  i, 500+currval('orders_id_seq'), CURRENT_TIMESTAMP(2), CURRENT_TIMESTAMP(2), CURRENT_TIMESTAMP(2), CURRENT_TIMESTAMP(2) ,'Some description', NULL),
										(i,	1+round(random()*7), 7,  i, 500+currval('orders_id_seq'), CURRENT_TIMESTAMP(2), CURRENT_TIMESTAMP(2), CURRENT_TIMESTAMP(2), CURRENT_TIMESTAMP(2) ,NULL , NULL),
                                        (i,	1+round(random()*7), 7,  i, 500+currval('orders_id_seq'), CURRENT_TIMESTAMP(2), CURRENT_TIMESTAMP(2), CURRENT_TIMESTAMP(2), CURRENT_TIMESTAMP(2) ,NULL , NULL);
				    ...
				    INSERT INTO orders	(user_id, office_id, order_status_id, sender_address_id, receiver_address_id, creation_time , confirmation_time, shipping_time, execution_time, description, feedback)
					VALUES				(i,	1+round(random()*7), 6, i, 500+currval('orders_id_seq'), CURRENT_TIMESTAMP(2), CURRENT_TIMESTAMP(2), CURRENT_TIMESTAMP(2), NULL ,'Some description', NULL);
					
					END LOOP;
					-- CONFIRMED ORDERS ( USERS FROM 401 - TILL 500 )
					FOR i IN 401..500 BY 1 LOOP
				    INSERT INTO orders	(user_id, office_id, order_status_id, sender_address_id, receiver_address_id, creation_time , confirmation_time, shipping_time, execution_time, description, feedback)
					VALUES				(i,	1+round(random()*7), 5, i, 500+currval('orders_id_seq'), CURRENT_TIMESTAMP(2), CURRENT_TIMESTAMP(2), CURRENT_TIMESTAMP(2), NULL ,'Some description', NULL);
					
					END LOOP;
					-- PROCESSING ORDERS ( USERS FROM 451 - TILL 500 )
					FOR i IN 451..500 BY 1 LOOP
				    INSERT INTO orders	(user_id, office_id, order_status_id, sender_address_id, receiver_address_id, creation_time , confirmation_time, shipping_time, execution_time, description, feedback)
					VALUES				(i,	1+round(random()*7), 4, i, 500+currval('orders_id_seq'), CURRENT_TIMESTAMP(2), NULL, NULL, NULL ,'Some description', NULL);
					
					END LOOP;
					-- POSTPONED ORDERS ( USERS FROM 451 - TILL 500 )
					FOR i IN 451..500 BY 1 LOOP
				    INSERT INTO orders	(user_id, office_id, order_status_id, sender_address_id, receiver_address_id, creation_time , confirmation_time, shipping_time, execution_time, description, feedback)
					VALUES				(i,	1+round(random()*7), 2, i, 500+currval('orders_id_seq'), CURRENT_TIMESTAMP(2), NULL, NULL, NULL ,'Some description', NULL);
				    ...
				    INSERT INTO orders	(user_id, office_id, order_status_id, sender_address_id, receiver_address_id, creation_time , confirmation_time, shipping_time, execution_time, description, feedback)
					VALUES				(i,	NULL , 1, i, 500+currval('orders_id_seq'), CURRENT_TIMESTAMP(2), NULL, NULL, NULL ,NULL, NULL);
				    ...
				    INSERT INTO orders	(user_id, office_id, order_status_id, sender_address_id, receiver_address_id, creation_time , confirmation_time, shipping_time, execution_time, description, feedback)
					VALUES				(i,	1+round(random()*7), 3, i, 500+currval('orders_id_seq'), CURRENT_TIMESTAMP(2), NULL, NULL, NULL ,'Some description', NULL);
					
					END LOOP;
					

							
					FOR i IN 1..2350 BY 1 LOOP
                    random := round(random()*1)+1;
                    IF random = 2 THEN
                    INSERT INTO services (order_id, courier_id, operator_id, date, attempt)
					VALUES	(i, round(random()*19)+31 ,round(random()*9)+21 , CURRENT_DATE, 1);
                    END IF;
					INSERT INTO services (order_id, courier_id, operator_id, date, attempt)
					VALUES	(i, round(random()*19)+31 ,round(random()*9)+21 , CURRENT_DATE, random);
